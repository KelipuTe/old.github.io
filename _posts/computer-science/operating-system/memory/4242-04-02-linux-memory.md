...
- 图片：linux-memory.drawio/2-2、32 位空间地址
- 图片：linux-memory.drawio/2-4、64 位空间地址
...
- 图片：linux-memory.drawio/2-6、32 位系统的用户空间分布情况
...
- 图片：linux-memory.drawio/4-2、brk() 申请内存
- 图片：linux-memory.drawio/4-4、mmap() 申请内存
...
- 图片：linux-memory.drawio/4-6、堆内存碎片
